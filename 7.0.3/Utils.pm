...
################################################################################
#  Copyright (c) 2014-2021, 2024 Broadcom.  All rights reserved.
...
sub ReadRpcProperty
{
   ...
   return Trim(
      ExecuteCommand("vmware-rpctool \"info-get $name\" 2>>$RPC_LOG_FILE"));
}
...
sub WriteRpcProperty
{
   ...
   ExecuteCommand("vmware-rpctool \"info-set $name $value\" 2>>$RPC_LOG_FILE");
}
