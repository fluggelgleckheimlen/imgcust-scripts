...
sub FindOsId
{
   ...
   if ($content =~ /Red.*Hat.*Enterprise.*Linux.*\s+(\d{1,2})/i) {
      ...
      if ($1 == 8) {
         $result = $MIRACLE . " $1";
         # Detect if the current OS is Miracle 8.6 or later
         if ($content =~ /MIRACLE.*?release\s+8\.(\d{1,2})/i) {
            if ($1 >= 6) {
               $isRelease86 = 1;
            }
         }
      ...
      #The first release version of RED OS 8.0
      if ($1 == 7 || $1 == 8) {
         $result = $REDOS . " $1";
      }
   }
...
#.............................................................................
# PR 2913883
# Remove check link down content from ifcfg file since RHEL 7 release
#.............................................................................

sub GetCheckLinkDownContent
{
   my ($self) = @_;
