...
sub Customize
{
   ...
   my $isInstantCloneNicsUp = 0;
   my $distro =
      CustomizationInstance::LoadCustomizationInstanceForIc(
         $isInstantCloneNicsUp,
         $customizationConfig);
...
sub NicsUp
{
   ...
   my $isInstantCloneNicsUp = 1;
   my $customizationConfig = undef; # No cust.cfg is provided for NicsUp
   my $distro =
      CustomizationInstance::LoadCustomizationInstanceForIc(
         $isInstantCloneNicsUp,
         $customizationConfig);
